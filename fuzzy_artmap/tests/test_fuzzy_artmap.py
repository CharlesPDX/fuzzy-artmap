...
def test_fuzzy_artmap_matches_expected_learning() -> None:
    """A unit test version of the step-by-step notebook, ensure that the hand calculated values (see examples/abridged-step-by-step.ipynb) 
    are the same as the ones generated by the model."""
